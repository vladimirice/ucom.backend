...
class AirdropsUsersExternalDataService {
    static async processForCurrentUserId(airdrop, currentUserDto) {
        ...
        if (data.json_data) {
            return Object.assign(Object.assign({}, data.json_data), { status: data.status });
        }
    ...
    static async processForUsersExternalId(airdrop, userExternalDto) {
        ...
        if (externalData) {
            return Object.assign(Object.assign({}, externalData.json_data), { status: externalData.status });
        }
    ...
    static async getUsersExternalData(airdrop, usersExternalId, githubUserId, majorTokens = false) {
        ...
        return Object.assign(Object.assign({}, commonData), { external_user_id: githubUserId });
    }
