...
class AirdropsUsersExternalDataService {
    ...
    static async processForUsersExternalId(airdropId, userExternalDto) {
        ...
        return this.createUsersExternalData(airdropId, userExternalDto.id, userExternalDto.external_id);
    }
    ...
    static async createUsersExternalData(airdropId, usersExternalId, githubUserId) {
        ...
        await AirdropsUsersExternalDataRepository.insertOneData(airdropId, usersExternalId, jsonData.score, jsonData, status);
