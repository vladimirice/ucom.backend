...
class AirdropUsersMigrateService {
    static async migrateFromFirstRoundToSecond(firstRoundAirdropId, secondRoundAirdropId) {
        const airdropsUsersIds = await AirdropsUsersExternalDataRepository.getAllAirdropUsersByAirdropId(firstRoundAirdropId, AirdropsModelProvider.getUsersExternalDataBlacklistedIds());
