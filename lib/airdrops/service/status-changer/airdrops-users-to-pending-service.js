...
class AirdropsUsersToPendingService {
    static async process(airdropId, airdropIdToExclude = null) {
        const manyFreshUsersBefore = await AirdropsUsersExternalDataRepository.getManyUsersWithStatusNew(airdropId);
        // TODO - temp code
        let usersExternalIdsToSkip = [];
