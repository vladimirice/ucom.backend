...
class UosAccountsPropertiesUpdateService {
    ...
    static async processBatchResult(response) {
        ...
        for (const propertiesList of accountsProperties) {
            ...
            manyItems.push(Object.assign(Object.assign({}, propertiesList.values), { account_name: propertiesList.name, entity_id: userIdsByAccountNames[propertiesList.name], entity_name: UsersModelProvider.getEntityName() }));
            processedCounter += 1;
        }
