...
import CommentsResendingService = require('../service/content-resending/comments-resending-service');
...
(async () => {
  ...
  const totalResponse = await CommentsResendingService.resendComments(
