...
class EntityNotificationsCreator {
     ...
     * @private
     */
    static async userTrustsOtherUser(activity) {
    ...
    static getExecutor(eventId) {
        const eventExecutors = {
            // mention
            [ucom_libs_common_1.EventsIdsDictionary.getUserHasMentionedYouInPost()]: this.userMentionsYouInsidePost,
            [ucom_libs_common_1.EventsIdsDictionary.getUserHasMentionedYouInComment()]: this.userMentionsYouInsideComment,
            // Following
            [ucom_libs_common_1.EventsIdsDictionary.getUserFollowsYou()]: this.userFollowsOtherUser,
            [ucom_libs_common_1.EventsIdsDictionary.getUserFollowsOrg()]: this.userFollowsOrg,
            // Trust
            [ucom_libs_common_1.EventsIdsDictionary.getUserTrustsYou()]: this.userTrustsOtherUser,
            // Commenting
            [ucom_libs_common_1.EventsIdsDictionary.getUserCommentsOrgPost()]: this.processUserCommentsOrgPost,
            [ucom_libs_common_1.EventsIdsDictionary.getUserCommentsOrgComment()]: this.processUserCommentsOrgComment,
            [ucom_libs_common_1.EventsIdsDictionary.getUserCommentsPost()]: this.userCreatesCommentForPost,
            [ucom_libs_common_1.EventsIdsDictionary.getUserCommentsComment()]: this.userCreatesCommentForComment,
            // Posting
            [ucom_libs_common_1.EventsIdsDictionary.userCreatesDirectPostForOtherUser()]: this.userCreatesDirectPostForOtherUser,
            [ucom_libs_common_1.EventsIdsDictionary.getUserCreatesDirectPostForOrg()]: this.userCreatesDirectPostForOrg,
            // Invitations
            [ucom_libs_common_1.EventsIdsDictionary.getOrgUsersTeamInvitation()]: this.createOrgBoardInvitation,
            // Voting
            [ucom_libs_common_1.EventsIdsDictionary.getUserUpvotesPostOfOtherUser()]: this.userVotesPostOfOtherUser,
            [ucom_libs_common_1.EventsIdsDictionary.getUserDownvotesPostOfOtherUser()]: this.userVotesPostOfOtherUser,
            [ucom_libs_common_1.EventsIdsDictionary.getUserUpvotesPostOfOrg()]: this.userVotesPostOfOrg,
            [ucom_libs_common_1.EventsIdsDictionary.getUserDownvotesPostOfOrg()]: this.userVotesPostOfOrg,
            [ucom_libs_common_1.EventsIdsDictionary.getUserUpvotesCommentOfOtherUser()]: this.userVotesCommentOfOtherUser,
            [ucom_libs_common_1.EventsIdsDictionary.getUserDownvotesCommentOfOtherUser()]: this.userVotesCommentOfOtherUser,
            [ucom_libs_common_1.EventsIdsDictionary.getUserUpvotesCommentOfOrg()]: this.userVotesCommentOfOrg,
            [ucom_libs_common_1.EventsIdsDictionary.getUserDownvotesCommentOfOrg()]: this.userVotesCommentOfOrg,
            // Repost
            [ucom_libs_common_1.EventsIdsDictionary.getUserRepostsOtherUserPost()]: this.userRepostsOtherUserPost,
            [ucom_libs_common_1.EventsIdsDictionary.getUserRepostsOrgPost()]: this.userRepostsOrgPost,
        };
