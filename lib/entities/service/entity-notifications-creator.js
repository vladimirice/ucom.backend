  ...
  static async _workWithEventId(activity) {
    switch(activity.event_id) {
      ...
      case EventIdDictionary.getUserCreatesDirectPostForOtherUser():
        return this._userCreatesDirectPostForOtherUser(activity);
      case EventIdDictionary.getUserCreatesDirectPostForOrg():
        return this._userCreatesDirectPostForOrg(activity);
      default:
        return null;
    }
  }
      ...
      case ActivityGroupDictionary.getGroupContentCreation():
        {
          ...
          await EntityNotificationRepository.createUserCreatesCommentForComment(activity, recipientId, jsonBody);
        }
        break;
      default:
        this._logNotProcessed(activity);
