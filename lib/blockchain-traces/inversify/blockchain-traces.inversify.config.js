...
const UpvotesTraceProcessor = require("../trace-processors/processors/upvotes-trace-processor");
function addTraceProcessors(diContainer) {
    ...
    diContainer.bind(di_interfaces_1.BlockchainTracesDiTypes.tracesProcessor).to(UpvotesTraceProcessor);
