...
const TransferTokensTraceProcessor = require("../trace-processors/transfer-tokens-trace-processor");
function addTraceProcessors(diContainer) {
    diContainer.bind(di_interfaces_1.BlockchainTracesDiTypes.tracesProcessor).to(TransferTokensTraceProcessor);
