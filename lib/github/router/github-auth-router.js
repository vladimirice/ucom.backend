...
async function fetchToken(code) {
    ...
    winston_1.AuthCallbackLogger.info(`Github token request response: ${JSON.stringify(resp)}`);
    // const sampleResponse = '{"access_token":"cb259e0f9ea2b0dc02323e80d3b6667e8ce6462e","token_type":"bearer","scope":""}';
    return JSON.parse(resp);
}
async function fetchPublicDataViaToken(accessToken) {
    ...
    winston_1.AuthCallbackLogger.info(`Github public data response is: ${publicData}`);
    /*
