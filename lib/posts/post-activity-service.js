...
class PostActivityService {
     ...
     * @private
     */
    static async checkVotePreconditionsAndGetModelTo(userFrom, modelId, body, activityTypeId) {
    ...
    static async userVotesPost(userFrom, modelTo, activityTypeId, signedTransaction) {
        ...
        const activity = await usersActivityService.createForUserVotesPost(activityTypeId, signedTransaction, userFrom.id, modelTo.id, eventId);
