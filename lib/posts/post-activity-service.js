    ...
    static getEventId(interactionType, modelTo) {
        if (interactionType === InteractionTypesDictionary.getUpvoteId()) {
            if (modelTo.organization_id) {
                return ucom_libs_common_1.EventsIdsDictionary.getUserUpvotesPostOfOrg();
            }
            return ucom_libs_common_1.EventsIdsDictionary.getUserUpvotesPostOfOtherUser();
        }
        if (interactionType === InteractionTypesDictionary.getDownvoteId()) {
            if (modelTo.organization_id) {
                return ucom_libs_common_1.EventsIdsDictionary.getUserDownvotesPostOfOrg();
            }
            return ucom_libs_common_1.EventsIdsDictionary.getUserDownvotesPostOfOtherUser();
        }
