...
class PostsRepository {
    ...
    static async createAutoUpdate(transaction, user_id, entity_id_for, entity_name_for, blockchain_id, json_data) {
        await transaction(TABLE_NAME).insert(Object.assign({ post_type_id: ucom_libs_common_1.ContentTypesDictionary.getTypeAutoUpdate(), user_id,
            entity_id_for,
            entity_name_for,
            blockchain_id,
            json_data }, this.getCreateDefaultFields()));
    }
