...
class PostsRepository {
    ...
    static processEntityNamesFor(query, params) {
        ...
        if (entityNamesFor.length !== 1) {
            throw new errors_1.BadRequestError('There is no business case yet for entity_names_for not to contain exactly one item. If there is such case, please consider removing this error.');
        }
