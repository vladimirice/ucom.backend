...
class PostsRepository {
  ...
  static getAllowedOrderBy() {
    return [
      'current_rate', 'id', 'title', 'comments_count', 'rate_delta', 'current_vote',
    ];
  }
   ...
   *
   * @param {Object|null} queryParameters
   * @param {boolean} isUpvoteDelta
   * @return {Promise<any[]>}
   */
  static async findAllPosts(queryParameters = {}, isUpvoteDelta = false) {
