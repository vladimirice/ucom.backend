...
class PostsRepository {
   ...
   * @return {Promise<any[]>}
   */
  static async findAllPosts(queryParameters = null) {
    ...
    const order = queryParameters ? queryParameters.order : null;

    const offset = queryParameters ? queryParameters['offset']: null;
    const limit = queryParameters ? queryParameters['limit'] : null;
