...
const RepostResendingService = require("../service/content-resending/repost-resending-service");
...
(async () => {
    ...
    const totalResponse = await RepostResendingService.resendReposts(createdAtLessOrEqualThan, limit, printPushResponse, offset);
