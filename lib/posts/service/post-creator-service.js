...
class PostCreatorService {
    static async processNewPostCreation(req, eventId = null, currentUser) {
        ...
        await EosPostsInputProcessor.addSignedTransactionDetailsToBody(body, currentUser, postTypeId, orgBlockchainId);
    ...
    static async processRepostCreation(givenBody, postId, currentUser) {
        ...
        await EosPostsInputProcessor.addSignedTransactionDetailsToBodyForRepost(body, currentUser, parentPost.blockchain_id);
