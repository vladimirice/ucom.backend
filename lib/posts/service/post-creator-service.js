...
class PostCreatorService {
    static async processNewPostCreation(req, eventId = null, currentUser) {
        ...
        const options = await EosPostsInputProcessor.addSignedTransactionDetailsToBody(body, currentUser, postTypeId, orgBlockchainId);
    ...
    static async createNewActivity(newPost, signedTransaction, currentUserId, eventId = null, transaction = null) {
        ...
        return UserActivityService.processUserHimselfCreatesPost(newPost, signedTransaction, currentUserId, transaction);
    }
    /**
     *
     * @param {number} userId
