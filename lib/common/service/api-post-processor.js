...
const ucom_libs_common_2 = require("ucom.libs.common");
    ...
    */
    ...
    static processManyPosts(posts, currentUserId = null, userActivity = null) {
        for (const post of posts) {
            ...
            if (post.post_type_id === ucom_libs_common_2.ContentTypesDictionary.getTypeRepost()) {
    ...
    static getRepostAvailableFlag(post, userPostActivity, currentUserId) {
        ...
        if (post.post_type_id === ucom_libs_common_2.ContentTypesDictionary.getTypeDirectPost()
