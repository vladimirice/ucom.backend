...
const trTypeToWhere = {
  ...
  // Prototype. It is better to process all required types
  // one by one in batch without separate requests by types
  [BlockchainTrTracesDictionary.getTypeMultiActions()]: {
    $and: [
      {"action_traces.act.account":       "eosio" },
