...
class BlockchainTrTracesService {
  ...
  private static async checkLastBlock() {
   ...
   * @private
   */
  private static async findAndSyncByTrType(trType, transactionIds) {
    let idGreaterThan;
   ...
   * @private
   */
  private static processDocsForStorage(docs, trType) {
    const result: any = [];
   ...
   * @private
   */
  private static processForTestEnv(model) {
...
export = BlockchainTrTracesService;
