...
const lengthToBreak = 100; // TODO - for tests
...
class BlockchainTrTracesService {
  ...
  static async syncMongoDbAndPostgres() {
    ...
    console.log(`Batch size is: ${BATCH_SIZE} and length to break is ${lengthToBreak}`);

    for(let i = 0; i < toProcess.length; i++) {
      console.log(`Lets begin sync for ${toProcess[i]}`);
