const { BlockchainMongoDbClient } = require('../../../config/mongodb');
...
class BlockchainService {
  ...
  static async mongoDbSample() {
    const db = await BlockchainMongoDbClient.getDbConnection();
    const collection = db.collection('transaction_traces');
    // Find some documents
