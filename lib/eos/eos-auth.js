...
class EosAuth {
  ...
  static async createAccount2(new_account_name, ownerPubKey, activePubKey) {
    console.warn(new_account_name);
    console.warn('Owner pk:', ownerPubKey);
    console.warn('Active pk: ', activePubKey);

    const creator = 'accregistrar';
    const creatorPrivateKey = '5KSSv6acEyUAm4i11Mw3qxkun8t4rTC63kWs4Heh5NVkHsf6gHe';
