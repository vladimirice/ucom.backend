...
const SMART_CONTRACT = 'tst.activity';
const CREATE_CONTENT_ACTION = 'makecontent';

/**
 * @deprecated
 * @see ContentTypeDictionary inside uos-app-transaction
 */
const CONTENT_TYPE_COMMENT = 3;

/**
 * @deprecated
 * in future all methods will be placed inside uos-app-transaction package
 */
class EosPosts {
  /**
   * @deprecated
   * @see uos-app-transaction
   *
