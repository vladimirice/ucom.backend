...
class EosTransactionService {
    ...
    static async appendSignedUserVotesContent(user, body, contentBlockchainId, activityTypeId) {
        ...
        body.signed_transaction = await TransactionFactory.getSignedUserToContentActivity(user.account_name, user.private_key, contentBlockchainId, activityTypeId);
    }
    /**
     *
     * @param {Object} body
    ...
    static async appendSignedUserCreatesDirectPostForOtherUser(body, user, accountNameTo) {
        ...
        body.signed_transaction = await TransactionFactory.getSignedDirectPostCreationForUser(user.account_name, user.private_key, accountNameTo, body.blockchain_id);
    }
    /**
     *
     * @param {Object} body
