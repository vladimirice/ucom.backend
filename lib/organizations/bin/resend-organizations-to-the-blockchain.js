...
const OrganizationsResendingService = require("../service/content-resending/organizations-resending-service");
...
(async () => {
    ...
    const totalResponse = await OrganizationsResendingService.resendOrganizations(createdAtLessOrEqualThan, limit, printPushResponse, offset);
