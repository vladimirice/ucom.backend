...
class OrganizationService {
  ...
  async getAllForPreview(query) {
    let queryParameters = QueryFilterService.getQueryParameters(query);
    ...
    const models = await OrganizationsRepositories.Main.findAllForPreview(queryParameters);
    ...
    let metadata = {
      ...
      has_more:     queryParameters['offset'] + queryParameters['limit'] < modelsTotalAmount,
    };
