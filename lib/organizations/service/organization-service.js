...
const OrganizationActivity = require('./organization-activity');
    ...
    return await db
      .transaction(async transaction => {
        ...
        const data = {
          ...
          user_id_from: this.currentUser.id,
          entity_id_to: newOrganization.id,
          entity_name: 'organization',
          signed_transaction: body.signed_transaction,
        };

        const newUserActivity = await OrganizationActivity.processNewOrganization(data);
