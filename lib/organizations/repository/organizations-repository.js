...
class OrganizationsRepository {
    ...
    static async countManyOrganizationsAsRelatedToEntity(params, relatedEntity, statsFieldName, overviewType) {
        if (relatedEntity !== PostsModelProvider.getEntityName()) {
            throw new errors_1.AppError(`Unsupported relatedEntity: ${relatedEntity}`, 500);
        }
    ...
    static async findManyAsRelatedToEntity(params, statsFieldName, entityName, overviewType) {
