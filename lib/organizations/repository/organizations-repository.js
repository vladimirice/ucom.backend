...
const OrgsCurrentParamsRepository = require("./organizations-current-params-repository");
...
class OrganizationsRepository {
    ...
    static async createNewOrganization(data, isMultiSignature, transaction) {
        const modelData = Object.assign(Object.assign({}, data), { organization_type_id: isMultiSignature ? organizations_dictionary_1.ORGANIZATION_TYPE_ID__MULTI_SIGNATURE : organizations_dictionary_1.ORGANIZATION_TYPE_ID__CONTENT });
    ...
    static async countAllOrganizations(requestQuery = null, params = null) {
    ...
    static async findAllOrgForList(query, params) {
        QueryFilterService.addExtraAttributes(params, OrgsCurrentParamsRepository.getStatsFields(), OrganizationsModelProvider.getCurrentParamsTableName());
        ...
        const jsonModels = res.toJSON();
        RepositoryHelper.convertStringFieldsToNumbersForArray(jsonModels, numericalFields, this.getFieldsToDisallowZero());
        return jsonModels;
    }
