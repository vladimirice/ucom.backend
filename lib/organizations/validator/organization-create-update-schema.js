...
const creationSchema = Object.assign({}, commonRules, { signed_transaction: joi.any().required(), blockchain_id: joi.any().required() });
const updatingSchema = Object.assign({}, commonRules, { signed_transaction: joi.any().allow('') });
