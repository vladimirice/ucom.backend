...
exports.resolvers = {
    JSON: graphQLJSON,
    Query: Object.assign(Object.assign(Object.assign(Object.assign({}, graphql_users_resolvers_1.graphqlUsersResolvers), graphql_posts_resolvers_1.graphqlPostsResolvers), graphql_organizations_resolvers_1.graphqlOrganizationsResolvers), { async many_blockchain_nodes(
        // @ts-ignore
        parent, args) {
            const customQuery = {
                filters: {
