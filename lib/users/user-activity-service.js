...
class UserActivityService {
   ...
   */
  static async userFollowsOrganization(userFrom, userIdTo, body) {
    const activityTypeId = ActivityDictionary.getFollowId();

    await this._userFollowOrUnfollowOrganization(userFrom, userIdTo, activityTypeId, body);
  }
   ...
   */
  static async userUnfollowsOrganization(userFrom, userIdTo) {
    const activity_type_id = ActivityDictionary.getUnfollowId();

    return await this._userFollowOrUnfollowOrganization(userFrom, userIdTo, activity_type_id);
  }
   ...
   * @private
   */
  static async _userFollowOrUnfollowOrganization(userFrom, userIdTo, activityTypeId, body = null) {
