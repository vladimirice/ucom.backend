...
class UserActivityService {
    ...
    static async processPostIsUpdated(updatedPost, currentUserId, transaction, signedTransaction = '') {
    ...
    static async processUserHimselfCreatesPost(newPost, signedTransaction, currentUserId, transaction = null) {
