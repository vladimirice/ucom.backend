...
class UsersActivityToNotificationRepository {
  ...
  static async findForUserVotesPostOfOtherUser(activityId) {
    const dataSet         = this._getDataAttributeForUser('user_id_from', 'data');
    const targetEntitySet = this._getDataAttributeForPost('entity_id_to', 'target_entity', false);
  ...
  static async findForUserRepostsOtherUserPost(activityId) {
    const dataSet         = this._getDataAttributeForPost('entity_id_to', 'data', false);
    const targetEntitySet = this._getDataAttributeForPost('entity_id_on', 'target_entity', false);
  ...
  static async findForUserRepostsOrgPost(activityId) {
    const dataSet         = this._getDataAttributeForPost('entity_id_to', 'data', false);
    const targetEntitySet = this._getDataAttributeForPost('entity_id_on', 'target_entity', true);
  ...
  static async findForUserVotesPostOfOrg(activityId) {
    const dataSet         = this._getDataAttributeForUser('user_id_from', 'data');
    const targetEntitySet = this._getDataAttributeForPost('entity_id_to', 'target_entity', true);
  ...
  static async findUserCreatesDirectPostForOtherUser(activityId) {
    const data          = this._getDataAttributeForPost('entity_id_to', 'data', false);
  ...
  static async findUserMentionsYouInsidePost(activityId) {
    const data          = this._getDataAttributeForPost('entity_id_on', 'data', false);
    const targetEntity  = this._getDataAttributeForUser('entity_id_to', 'target_entity');
  ...
  static async findUserMentionsYouInsideComment(activityId) {
    const data          = this._getDataAttributeForComment('entity_id_on', 'data', false);
    const targetEntity  = this._getDataAttributeForUser('entity_id_to', 'target_entity');
  ...
  static async findForUserCreatesCommentForPost(activityId) {
    const data    = this._getDataAttributeForComment('entity_id_to', 'data', false);
    const target  = this._getDataAttributeForPost('entity_id_on', 'target_entity', false);
  ...
  static async findForUserCreatesCommentForOrgPost(activityId) {
    const data    = this._getDataAttributeForComment('entity_id_to', 'data', false);
    const target  = this._getDataAttributeForPost('entity_id_on', 'target_entity', true);
   ...
   * @private
   */
  static _getDataAttributeForPost(activityColumn, dataAlias, isOfOrg) {
    const attributes = {
