...
class UsersActivityToNotificationRepository {
  ...
  public static async findForUserTrustsOtherUser(activityId: number) {
    const dataSet         = this.getDataAttributeForUser('user_id_from', 'data');
    const targetEntitySet = this.getDataAttributeForUser('entity_id_to', 'target_entity');
  ...
  static async findForUserVotesCommentOfOtherUser(activityId) {
    const dataSet         = this.getDataAttributeForUser('user_id_from', 'data');
    const targetEntitySet = this.getDataAttributeForComment(
      'entity_id_to',
      'target_entity',
      false,
    );
   ...
   * @private
   */
  private static getDataAttributeForPost(activityColumn, dataAlias, isOfOrg) {
    const attributes = {
   ...
   * @private
   */
  private static getDataAttributeForComment(activityColumn, dataAlias, isOfOrg) {
    const attributes = {
   ...
   * @private
   */
  private static getDataAttributeForUser(activityColumn, dataAlias) {
    const attributes = {
   ...
   * @private
   */
  private static getDataAttributeForOrg(activityColumn, dataAlias) {
    const attributes = {
   ...
   * @private
   */
  private static async findForNotification(dataSet, targetEntitySet, activityId) {
   ...
   * @private
   */
  private static addToSelectArrayByAlias(alias, tableName, toSelect) {
    let dataAttributes;
   ...
   * @private
   */
  private static isAuthorNeededForNotifications(tableName) {
    const set = [
   ...
   * @private
   */
  private static isOrgNeededForNotification(tableName) {
    const set = [
      commentsModelProvider.getTableName(),
      postsModelProvider.getTableName(),
    ];
   ...
   * @private
   */
  private static isPostNeededForNotification(tableName) {
    const set = [
      commentsModelProvider.getTableName(),
    ];
   ...
   * @private
   */
  private static addRequiredJoin(tableName, alias, joinColumn) {
...
export = UsersActivityToNotificationRepository;
