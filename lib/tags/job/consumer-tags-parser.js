        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return channel.consume(queueName, (message) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const processedAsPost = yield postActivityProcessor.processOneActivity(parsedMessageContent.id);
                    if (!processedAsPost) {
                        yield commentsActivityProcessor.processOneActivity(parsedMessageContent.id);
                    }
                }
                catch (err) {
