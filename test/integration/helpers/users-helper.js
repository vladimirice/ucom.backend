...
const UsersChecker = require("../../helpers/users/users-checker");
...
class UsersHelper {
    ...
    static async directlySetUserConfirmsInvitation(orgId, user) {
        await usersTeamRepository.setStatusConfirmed(orgModelProvider.getEntityName(), orgId, user.id);
    }
    ...
    static async getAllSampleUsersFromDb() {
        return Promise.all([
            this.getUserVlad(),
            this.getUserJane(),
            this.getUserPetr(),
    ...
    static async getUserVlad() {
        ...
        return Object.assign({}, vladSeed, vladDbData, { token, github_code: 'github_code_vlad' });
    }
    /**
     * @param {Object} user
    ...
    static async getUserPetr() {
        ...
        return Object.assign({}, seed, data, { token });
    }
    /**
     *
     * @returns {Promise<Object>}
    ...
    static async getUserJane() {
        ...
        const token = authService.getNewJwtToken(data);
        return Object.assign({}, seed, data, { token, github_code: 'github_code_jane' });
    }
