...
describe('Organization creates post.', () => {
  describe('Positive scenarios', () => {
    it('Legacy - should be possible to create post on behalf of organization by org author', async () => {
  ...
  describe('Negative scenarios', () => {
    ...
    it('should NOT be possible to create post on behalf of organization by member with pending invitation', async () => {
      ...
      // noinspection JSDeprecatedSymbols
      await PostsHelper.requestToCreateMediaPostOfOrganization(userJane, orgId, 403);
    });
